...
import '../../Css/createRequsest.css'; // Updated CSS import
...
const CreateRequestPage = () => {
  ...
  if (error) return <p className="create-request-error">{error}</p>;
  ...
  return (
    <div className="create-request-form">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="create-request-submit-button">Submit Request</button>
      </form>
    </div>
  );
};
